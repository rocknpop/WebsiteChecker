...
import { DecisionReport, FAQ, BlogPost, RecentDecision, generateFallbackReport, seedDecisions, blogPosts as blogPostsData, recentSeed, decisionCache, recentQueries } from "../lib/shared-data";
...
export default function Home({ currentPath, onNavigate }: HomeProps) {
  ...
  const [recentDecisions, setRecentDecisions] = useState<RecentDecision[]>(recentSeed);
